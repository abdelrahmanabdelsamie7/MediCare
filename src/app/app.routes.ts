...
export const routes: Routes = [
  ...
  // ======================== Lazy-Loaded Listings ========================
  {
    path: 'pharmacies',
    loadComponent: () =>
      import('./Site/components/all-pharmacies/all-pharmacies.component').then(
  ...
  },
  {
    path: 'laboratories',
    loadComponent: () =>
      import('./Site/components/all-laboratories/all-laboratories.component').then(
        (m) => m.AllLaboratoriesComponent
      ),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./Site/components/all-delivery-services/all-delivery-services.component').then(
        (m) => m.AllDeliveryServicesComponent
      ),
...
{
  path: 'details',
  loadChildren: () => import('./Site/details/details.routes').then((m) => m.DETAILS_ROUTES),
},
  // ======================== AI Section ========================
